let namecategory = localStorage.getItem("name-category");
console.log(namecategory);
// let allLinks_li=localStorage.getItem("nav-name-category")

// get element in landing
let type = document.querySelector(".landing .landing-title span");
type.innerHTML = namecategory;

let pageSec = document.querySelector(".landing .page-sec");
pageSec.innerHTML = namecategory;

async function getMostRecipes(namecategory) {
  let slide1 = "";
  try {
          ...
          <div class="item-container">
            ...
            <div class="item-content">
              <h3>
                ...
                <small class="sinregrents">${namecategory}</small>
              </h3>
              <div class="avatar">
